...
<template>
  ...
  >
    <div v-if="canLogin" class="sm:fixed sm:top-0 sm:end-0 p-6 text-end z-10">
      ...
      <template v-if="$page.props.auth.user && $page.props.auth.user.id === 1">
        <Link
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
      ...
      <div class="flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
        ...
        <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-end sm:ms-0">Laravel v{{ laravelVersion }} (PHP v{{ phpVersion }})</div>
      </div>
    </div>
  </div>
</template>
